...
setwd("C:/Users/linos/OneDrive/Documentos/RProjects/econJobMarket/Rscripts")
...
for (j in 1:nwebpages) {
    ...
    ejmurl   <- paste0("https://econjobmarket.org/positions?page=",j)
